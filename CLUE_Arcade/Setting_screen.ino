...
int action;
void draw_word(int, int, char*, CRGB::HTMLColorCode);
void setting_screen()
{
  clearScreen();
  GameOver = true;
  ...
  choice = "";
  draw_word(seting_start_pos_col, seting_start_pos_row, (char*)"SETING", CRGB::Green);
  ...
  draw_word(bright_start_pos_col, bright_start_pos_row, (char*)"BRIGHT", CRGB::White);
